...
# MAGIC
# MAGIC Triggered by changes to `lb_github_repos_<username>_history`.
...
# Lakebase source is bootcamp_students.github_repos_<username>.
# CDF materializes it as lb_github_repos_<username>_history.
SOURCE_TABLE = f"{catalog}.{schema}.lb_github_repos_{username}_history"
TARGET_TABLE = f"{catalog}.{schema}.github_repos_scd_{username}"
WATERMARK_TABLE = f"{catalog}.{schema}.scd_watermarks_{username}"
print(f"SOURCE_TABLE   = {SOURCE_TABLE}")
print(f"TARGET_TABLE   = {TARGET_TABLE}")
print(f"WATERMARK_TABLE= {WATERMARK_TABLE}")
